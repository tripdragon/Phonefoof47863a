...
function renderKanjiLookUpRoute() {
  return renderPixelStudio(routeContent, {
    copy: {
      ...
      sessionHint: "A fresh stroke-count session starts automatically so you can compare your live line total with common kana and kanji right away.",
      ...
      matchesEmpty: "No live count yet. Draw to see matching characters.",
      bestGuessLabel: "Best guess",
      bestGuessHint: "A lightweight template-matching pass compares your sketch to saved character silhouettes and picks the closest fit.",
      bestGuessFilterLabel: "Filter to current lines",
      bestGuessFilterHint: "Keep this off for the full database, or turn it on to only guess from characters matching the live line count.",
      bestGuessEmpty: "Sketch a character to see the closest saved match.",
      bestGuessNoFilteredMatch: "No saved character matches the current line-count filter yet.",
      databaseLabel: "Character database",
      databaseHint: "Load the saved kana and kanji grouped into line-count slices for quick browsing.",
      databaseButtonLabel: "Load database",
      databaseEmpty: "Load the database to browse every saved character grouped by line count.",
      clearButtonLabel: "Reset for new session",
    },
    initialBrushSize: 2,
