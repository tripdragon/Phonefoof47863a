...
export function renderRubixCRoute(container) {
  container.innerHTML = `
    ...
    <h1 class="hero-title">55a 4vc 22 A 974 77655422b ggfh14kujyi 12bbb 8b 7b 555m 44 b 12221ab  9193 8787 777@5554433@2b q e01@ rubixC 2</h1>
  ...
  build(){
    if(this.colors.length > 0){
      ...
      if(this.colors.length > 2){
        ...
        let p2 = makePlane(color=this.colors[2]);
        this.add(p2);
        // p2.rotation.x = Math.PI * 0.5;
        // p2.rotation.z = Math.PI * 0.5;
        // p2.position.y = -0.5;
